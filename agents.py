...
class Code_Fixer():
    ...
    def initiate(self):
        ...
        messages = [
            {"role": "system", "content":"You are specialist in providing remedy to the incorrect code and error provided to you. Be very categorical in you response as the response being generated by you is beign used by another LLM"},
        ]
