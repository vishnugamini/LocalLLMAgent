...
voiceInputBtn.classList.remove("show");
...
promptTextareas.addEventListener("input", function () {
    ...
    if (this.value.trim() !== "") {
        voiceInputBtn.classList.add("show");
    } else {
        voiceInputBtn.classList.remove("show");
    }
});
...
const localagent = document.getElementById("localLLMagent");
const aboutModal = document.getElementById("about-modal");

localagent.addEventListener("click", () => {
